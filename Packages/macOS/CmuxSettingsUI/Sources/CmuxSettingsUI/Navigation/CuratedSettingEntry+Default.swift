...
extension Array where Element == CuratedSettingEntry {
    ...
    public static var cmuxDefault: [CuratedSettingEntry] {
        [
            ...
            .init(section: .terminal, id: "hebrew-ascii-quotes", title: String(localized: "settings.terminal.hebrewAsciiQuotes", defaultValue: "ASCII Quotes on Hebrew Layout"), synonyms: "ASCII Quotes on Hebrew Layout terminal.hebrewAsciiQuotes hebrew ascii quotes geresh gershayim apostrophe quote punctuation rtl ivrix shell quoting layout"),
