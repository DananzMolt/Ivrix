...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.terminal, "hebrew-font", String(localized: "settings.terminal.hebrewFont", defaultValue: "Hebrew Font"), "terminal.hebrewFont hebrew font face typeface rtl bidi noto miriam alef heebo assistant plex rubik varela frank ruhl david secular cousine"),
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        "terminal.hebrewFont": settingID(for: .terminal, idSuffix: "hebrew-font"),
